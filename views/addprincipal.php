          ...
          <div class="container">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <form action="../process/addprincipal.php" method="post">
                  <div class="form-group">
                    <label for="">Name</label>
                    <input class="form-control" type="text" name="PrincipalName" required>
                  </div>
                  <div class="form-group">
                  ...
                  <button class="btn btn-info"type="submit" name="AddPrincipal">ADD</button>
                </form>
              </div>
            </div>
