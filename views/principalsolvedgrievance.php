...
if (!isset($_SESSION['USERNAME'])){
     ...
     try {
             ...
             $stmt = $conn->prepare("SELECT * FROM grievancec WHERE status='Solved'AND level='Principal'");
             $stmt->execute();
      ...
      <?php require 'sub-views/principalsidenav.php'; ?>
       ...
       <div id="main">
         <div class="container">
           ...
           <h5 class="dispay-4">Solved Grievance Cases</h5>
               ...
               <tbody>
                 ...
                 <tr>
                   ...
                   <td>
                    ...
                    <td>
                      <a href="grievanceprincipalpage.php?id=<?php echo $value['id'];?>" class="btn btn-info">View</a>
                    </td>
